    ...
    return Scaffold(
      ...
      body: BlocConsumer<AdminBloc, AdminState>(
        ...
        builder: (context, state) {
          if (state.status == AdminStatus.loading && state.chatbotSettings == null) {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('This is the core instruction set for the AI assistant. Edit with care.', style: TextStyle(color: Colors.grey.shade700)),
